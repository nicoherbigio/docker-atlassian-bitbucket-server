# Building instructions for the Atlassian Bitbucket Server Docker image
...
```
# Build the Docker image
docker build --no-cache --pull --tag nicoherbigde/atlassian-bitbucket-server:7.21-jammy 7.21/ubuntu/default
```
...
docker push nicoherbigde/atlassian-bitbucket-server:7.21-jammy
```
