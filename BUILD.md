...
```
# Build the Docker image
docker build --no-cache --pull --tag nicoherbigde/atlassian-bitbucket-server:7.21 7.21/ubuntu/default
```
...
docker push nicoherbigde/atlassian-bitbucket-server:7.21
```
